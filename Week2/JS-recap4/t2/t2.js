...
restaurants.forEach((r) => {
  ...
  tableRow.addEventListener("click", () => {
    selectedRestaurant?.classList.remove("highlighted");
    tableRow.classList.add("highlighted");
    selectedRestaurant = tableRow;
  ...
  const rAddress = document.createElement("td");
  rAddress.textContent = r.address;

  tableRow.append(rName, rAddress);
